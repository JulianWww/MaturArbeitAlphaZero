...
\newcommand{\rewardArrow}[2]{\(\xrightarrow[= #2]{R(s,#1)}\) }
...
Because a MCTS changes during simulation, idices are used to specify which simulation step the tree is in. A MCTS simulation consists of three phases \nameref{sec:Methods:MCTS:Leaf_selection}, \nameref{sec:Methods:MCTS:Node Evaluation and Expansion} and \nameref{sec:Methods:MCTS:Backfill}.
